/*Servlet para el registro de un espectaculo múltiple*/
...
public class MultipleServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Recogemos las sesiones del espectaculo en un array
		...
		if(GE.existeEspectaculo(titulo_mult)) { //si existe mostramos mensaje de error
