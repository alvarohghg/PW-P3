...
<%
	...
	ArrayList<EspectaculoPuntual> ListaPuntual = PDAO.obtenerPuntual();
	ArrayList<EspectaculoTemporada> ListaTemporada = TDAO.obtenerTemporada();
	...
	for(int i=0;i<ListaTemporada.size();i++) {
		l.add(ListaTemporada.get(i).getTitulo());					
	}
	for(int i=0;i<ListaPuntual.size();i++) {
		l.add(ListaPuntual.get(i).getTitulo());					
	}
	%>
<!DOCTYPE html>
<html>
